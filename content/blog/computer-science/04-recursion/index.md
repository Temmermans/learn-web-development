...
description: Learn what recursion is and how you can use it to perform complex operations
...
![diagram of calls in the fibonacci sequences on fibonacci(5). each one eventually breaks down into calling a fibonacci(2) or a fibonacci(1) call which returns 1](./fibonacci.png)
...
<iframe src="https://stackblitz.com/edit/node-c2c8r7?embed=1&file=index.test.js&view=editor"></iframe>
...
<iframe src="https://stackblitz.com/edit/node-gq1zqq?embed=1&file=index.test.js&view=editor"></iframe>
